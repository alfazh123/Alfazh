...
export default function CardHobby({
    ...
    return (
        <div className="group relative">
            <div className="w-48 h-56 dark:bg-slate600 bg-sand absolute rounded-md group-hover:-translate-x-2 group-hover:translate-y-2 transition ease-in-out duration-700"></div>
            <Link
                href={link}
