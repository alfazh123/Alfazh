...
export const AboutButton = () => {
    return (
        <Link
            href="/about"
            className="my-4 border-solid border w-24 md:text-base text-sm dark:border-slate200 border-slate700 dark:hover:bg-slate200 hover:bg-slate700 hover:text-slate200 dark:hover:text-slate800 px-3 py-2 rounded-lg"
        >
            About Me
        </Link>
    );
