...
export default function Blog({ params }: { params: { slug: string } }) {
    ...
    return (
        <div className="pt-28">
            <section
                className={`px-4 pt-20 backdrop-blur-2xl space-y-5 bg-white dark:bg-black100 bg-opacity-40 dark:bg-opacity-25 md:rounded-xl rounded-lg ${inter.className}`}
            >
                {/* <Suspense fallback={<SkeletonBlogContent />}> */}
                    <header className="flex md:flex-row flex-col gap-4 min-h-32">
                        <Link href="/blog" className="md:w-20">
